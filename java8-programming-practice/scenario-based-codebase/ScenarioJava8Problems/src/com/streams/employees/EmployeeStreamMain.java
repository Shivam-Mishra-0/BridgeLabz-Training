...
public class EmployeeStreamMain 
{
	...
	public static void main(String[] args) {
		...
		employees.add(new Employee(1, "Vaidik", 22, "Male", "Senior Management", 2026, 700000));
		employees.add(new Employee(2, "Raghav", 22, "Male", "Sales", 2025, 75000));
		employees.add(new Employee(3, "Shivam", 23, "Male", "Security", 2026, 5000));
		employees.add(new Employee(4, "Ravi", 23, "Male", "Sales", 2023, 65000));
		employees.add(new Employee(5, "siri", 35, "Female", "HR", 2020, 70000));
		employees.add(new Employee(6, "Alexa", 21, "Male", "Product Development", 2020, 15000));
