...
public class StudentStreamMain 
{
	...
	public static void main(String[] args) {
		...
		students.add(new Student(1, "Vaidik", 22, "Male", "Mumbai", "Computer", 12, List.of("9000000001")));
		students.add(new Student(2, "Ravi", 24, "Male", "Delhi", "Mechanical", 45, List.of("9000000002", "9000000003")));
		students.add(new Student(3, "Shivam", 21, "Male", "Karnataka", "Electronics", 78, List.of("9000000004")));
		students.add(new Student(4, "Raghav", 26, "Male", "Mumbai", "Computer", 33, List.of("9000000005", "9000000006")));
		students.add(new Student(5, "Saurav", 23, "Male", "Delhi", "Biotech", 60, List.of("9000000007")));
		students.add(new Student(6, "Akshat", 25, "Male", "Karnataka", "Mechanical", 15, List.of("9000000008")));
		...
		students.add(new Student(9, "Ananya", 26, "Female", "Karnataka", "Electronics", 55, List.of("9000000011", "9000000012")));
