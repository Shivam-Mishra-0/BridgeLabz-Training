//Creating a class name with DoubleOperation indicating to purpose is to understand the precedence of the operators.
import java.util.Scanner;
public class DoubleOperation
{	public static void main(String args[])
	{	
		//Create a double vairable name with a, b, c, operation1, operation2, operation3 and operation4.
