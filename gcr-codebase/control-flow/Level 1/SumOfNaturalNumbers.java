//Creating a class name with SumOfNaturalNumbers indicating to purpose is to find the sum of natural numbers and compare with a formaulae.
...
{	public static void main(String args[])
	{	//Create a int vairable name with number, check.
		...
		//Find the sum of natural numbers using both while loop and formulae
		duplicateNumber = number; // Storing the number for later use.
		int numberWhile = 0;
		while ( duplicateNumber > 0 )
		{	numberWhile += duplicateNumber;
			duplicateNumber--;
		}
		numberFormulae = number * ( number + 1 ) / 2;

		//Compare two results and print		
		if ( numberWhile == numberFormulae )
		{	System.out.println("The sum of natural number using while is " + numberWhile);
