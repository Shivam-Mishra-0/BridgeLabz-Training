//Creating a class name with StudentGrade indicating to purpose is to find the BMI and display the height, weight, BMI and status of each individual using multi-dimensional array.
